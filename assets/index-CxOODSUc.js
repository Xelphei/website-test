...
`,c):e.result+=w.repeat(`
`,o?1+c:c),o=!0,l=!0,c=0,r=e.position;!T(d)&&d!==0;)d=e.input.charCodeAt(++e.position);F(e,r,e.position,!1)}return!0}function ke(e,n){var r,t=e.tag,i=e.anchor,o=[],l,a=!1,c;if(e.firstTabInLine!==-1)return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=o),c=e.input.charCodeAt(e.position);c!==0&&(e.firstTabInLine!==-1&&(e.position=e.firstTabInLine,p(e,"tab characters must not be used in indentation")),!(c!==45||(l=e.input.charCodeAt(e.position+1),!k(l))));){if(a=!0,e.position++,b(e,!0,-1)&&e.lineIndent<=n){o.push(null),c=e.input.charCodeAt(e.position);continue}if(r=e.line,P(e,n,on,!1,!0),o.push(e.result),b(e,!0,-1),c=e.input.charCodeAt(e.position),(e.line===r||e.lineIndent>n)&&c!==0)p(e,"bad indentation of a sequence entry");else if(e.lineIndent<n)break}return a?(e.tag=t,e.anchor=i,e.kind="sequence",e.result=o,!0):!1}function jr(e,n,r){var t,i,o,l,a,c,s=e.tag,u=e.anchor,d={},f=Object.create(null),m=null,h=null,g=null,y=!1,$=!1,x;if(e.firstTabInLine!==-1)return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=d),x=e.input.charCodeAt(e.position);x!==0;){if(!y&&e.firstTabInLine!==-1&&(e.position=e.firstTabInLine,p(e,"tab characters must not be used in indentation")),t=e.input.charCodeAt(e.position+1),o=e.line,(x===63||x===58)&&k(t))x===63?(y&&(j(e,d,f,m,h,null,l,a,c),m=h=g=null),$=!0,y=!0,i=!0):y?(y=!1,i=!0):p(e,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),e.position+=1,x=t;else{if(l=e.line,a=e.lineStart,c=e.position,!P(e,r,tn,!1,!0))break;if(e.line===o){for(x=e.input.charCodeAt(e.position);N(x);)x=e.input.charCodeAt(++e.position);if(x===58)x=e.input.charCodeAt(++e.position),k(x)||p(e,"a whitespace character is expected after the key-value separator within a block mapping"),y&&(j(e,d,f,m,h,null,l,a,c),m=h=g=null),$=!0,y=!1,i=!1,m=e.tag,h=e.result;else if($)p(e,"can not read an implicit mapping pair; a colon is missed");else return e.tag=s,e.anchor=u,!0}else if($)p(e,"can not read a block mapping entry; a multiline key may not be an implicit key");else return e.tag=s,e.anchor=u,!0}if((e.line===o||e.lineIndent>n)&&(y&&(l=e.line,a=e.lineStart,c=e.position),P(e,n,Q,!0,i)&&(y?h=e.result:g=e.result),y||(j(e,d,f,m,h,g,l,a,c),m=h=g=null),b(e,!0,-1),x=e.input.charCodeAt(e.position)),(e.line===o||e.lineIndent>n)&&x!==0)p(e,"bad indentation of a mapping entry");else if(e.lineIndent<n)break}return y&&j(e,d,f,m,h,null,l,a,c),$&&(e.tag=s,e.anchor=u,e.kind="mapping",e.result=d),$}function Pr(e){var n,r=!1,t=!1,i,o,l;if(l=e.input.charCodeAt(e.position),l!==33)return!1;if(e.tag!==null&&p(e,"duplication of a tag property"),l=e.input.charCodeAt(++e.position),l===60?(r=!0,l=e.input.charCodeAt(++e.position)):l===33?(t=!0,i="!!",l=e.input.charCodeAt(++e.position)):i="!",n=e.position,r){do l=e.input.charCodeAt(++e.position);while(l!==0&&l!==62);e.position<e.length?(o=e.input.slice(n,e.position),l=e.input.charCodeAt(++e.position)):p(e,"unexpected end of the stream within a verbatim tag")}else{for(;l!==0&&!k(l);)l===33&&(t?p(e,"tag suffix cannot contain exclamation marks"):(i=e.input.slice(n-1,e.position+1),ln.test(i)||p(e,"named tag handle cannot contain such characters"),t=!0,n=e.position+1)),l=e.input.charCodeAt(++e.position);o=e.input.slice(n,e.position),Sr.test(o)&&p(e,"tag suffix cannot contain flow indicator characters")}o&&!an.test(o)&&p(e,"tag name cannot contain such characters: "+o);try{o=decodeURIComponent(o)}catch{p(e,"tag name is malformed: "+o)}return r?e.tag=o:I.call(e.tagMap,i)?e.tag=e.tagMap[i]+o:i==="!"?e.tag="!"+o:i==="!!"?e.tag="tag:yaml.org,2002:"+o:p(e,'undeclared tag handle "'+i+'"'),!0}function Yr(e){var n,r;if(r=e.input.charCodeAt(e.position),r!==38)return!1;for(e.anchor!==null&&p(e,"duplication of an anchor property"),r=e.input.charCodeAt(++e.position),n=e.position;r!==0&&!k(r)&&!R(r);)r=e.input.charCodeAt(++e.position);return e.position===n&&p(e,"name of an anchor node must contain at least one character"),e.anchor=e.input.slice(n,e.position),!0}function qr(e){var n,r,t;if(t=e.input.charCodeAt(e.position),t!==42)return!1;for(t=e.input.charCodeAt(++e.position),n=e.position;t!==0&&!k(t)&&!R(t);)t=e.input.charCodeAt(++e.position);return e.position===n&&p(e,"name of an alias node must contain at least one character"),r=e.input.slice(n,e.position),I.call(e.anchorMap,r)||p(e,'unidentified alias "'+r+'"'),e.result=e.anchorMap[r],b(e,!0,-1),!0}function P(e,n,r,t,i){var o,l,a,c=1,s=!1,u=!1,d,f,m,h,g,y;if(e.listener!==null&&e.listener("open",e),e.tag=null,e.anchor=null,e.kind=null,e.result=null,o=l=a=Q===r||on===r,t&&b(e,!0,-1)&&(s=!0,e.lineIndent>n?c=1:e.lineIndent===n?c=0:e.lineIndent<n&&(c=-1)),c===1)for(;Pr(e)||Yr(e);)b(e,!0,-1)?(s=!0,a=o,e.lineIndent>n?c=1:e.lineIndent===n?c=0:e.lineIndent<n&&(c=-1)):a=!1;if(a&&(a=s||i),(c===1||Q===r)&&(V===r||tn===r?g=n:g=n+1,y=e.position-e.lineStart,c===1?a&&(ke(e,y)||jr(e,y,g))||Br(e,g)?u=!0:(l&&Rr(e,g)||Hr(e,g)||Dr(e,g)?u=!0:qr(e)?(u=!0,(e.tag!==null||e.anchor!==null)&&p(e,"alias node should not have any properties")):Nr(e,g,V===r)&&(u=!0,e.tag===null&&(e.tag="?")),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):c===0&&(u=a&&ke(e,y))),e.tag===null)e.anchor!==null&&(e.anchorMap[e.anchor]=e.result);else if(e.tag==="?"){for(e.result!==null&&e.kind!=="scalar"&&p(e,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+e.kind+'"'),d=0,f=e.implicitTypes.length;d<f;d+=1)if(h=e.implicitTypes[d],h.resolve(e.result)){e.result=h.construct(e.result),e.tag=h.tag,e.anchor!==null&&(e.anchorMap[e.anchor]=e.result);break}}else if(e.tag!=="!"){if(I.call(e.typeMap[e.kind||"fallback"],e.tag))h=e.typeMap[e.kind||"fallback"][e.tag];else for(h=null,m=e.typeMap.multi[e.kind||"fallback"],d=0,f=m.length;d<f;d+=1)if(e.tag.slice(0,m[d].tag.length)===m[d].tag){h=m[d];break}h||p(e,"unknown tag !<"+e.tag+">"),e.result!==null&&h.kind!==e.kind&&p(e,"unacceptable node kind for !<"+e.tag+'> tag; it should be "'+h.kind+'", not "'+e.kind+'"'),h.resolve(e.result,e.tag)?(e.result=h.construct(e.result,e.tag),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):p(e,"cannot resolve a node with !<"+e.tag+"> explicit tag")}return e.listener!==null&&e.listener("close",e),e.tag!==null||e.anchor!==null||u}function Ur(e){var n=e.position,r,t,i,o=!1,l;for(e.version=null,e.checkLineBreaks=e.legacy,e.tagMap=Object.create(null),e.anchorMap=Object.create(null);(l=e.input.charCodeAt(e.position))!==0&&(b(e,!0,-1),l=e.input.charCodeAt(e.position),!(e.lineIndent>0||l!==37));){for(o=!0,l=e.input.charCodeAt(++e.position),r=e.position;l!==0&&!k(l);)l=e.input.charCodeAt(++e.position);for(t=e.input.slice(r,e.position),i=[],t.length<1&&p(e,"directive name must not be less than one character in length");l!==0;){for(;N(l);)l=e.input.charCodeAt(++e.position);if(l===35){do l=e.input.charCodeAt(++e.position);while(l!==0&&!T(l));break}if(T(l))break;for(r=e.position;l!==0&&!k(l);)l=e.input.charCodeAt(++e.position);i.push(e.input.slice(r,e.position))}l!==0&&he(e),I.call(Ee,t)?Ee[t](e,t,i):z(e,'unknown document directive "'+t+'"')}if(b(e,!0,-1),e.lineIndent===0&&e.input.charCodeAt(e.position)===45&&e.input.charCodeAt(e.position+1)===45&&e.input.charCodeAt(e.position+2)===45?(e.position+=3,b(e,!0,-1)):o&&p(e,"directives end mark is expected"),P(e,e.lineIndent-1,Q,!1,!0),b(e,!0,-1),e.checkLineBreaks&&Tr.test(e.input.slice(n,e.position))&&z(e,"non-ASCII line breaks are interpreted as content"),e.documents.push(e.result),e.position===e.lineStart&&ee(e)){e.input.charCodeAt(e.position)===46&&(e.position+=3,b(e,!0,-1));return}if(e.position<e.length-1)p(e,"end of the stream or a document separator is expected");else return}function fn(e,n){e=String(e),n=n||{},e.length!==0&&(e.charCodeAt(e.length-1)!==10&&e.charCodeAt(e.length-1)!==13&&(e+=`
`),e.charCodeAt(0)===65279&&(e=e.slice(1)));var r=new Or(e,n),t=e.indexOf("\0");for(t!==-1&&(r.position=t,p(r,"null byte is not allowed in input")),r.input+="\0";r.input.charCodeAt(r.position)===32;)r.lineIndent+=1,r.position+=1;for(;r.position<r.length-1;)Ur(r);return r.documents}function Gr(e,n,r){n!==null&&typeof n=="object"&&typeof r>"u"&&(r=n,n=null);var t=fn(e,r);if(typeof n!="function")return t;for(var i=0,o=t.length;i<o;i+=1)n(t[i])}function Kr(e,n){var r=fn(e,n);if(r.length!==0){if(r.length===1)return r[0];throw new C("expected a single document in the stream, but found more")}}var Wr=Gr,Vr=Kr,pn={loadAll:Wr,load:Vr},mn=Object.prototype.toString,hn=Object.prototype.hasOwnProperty,xe=65279,Qr=9,G=10,zr=13,Xr=32,Zr=33,Jr=34,ce=35,ei=37,ni=38,ri=39,ii=42,gn=44,ti=45,X=58,oi=61,li=62,ai=63,ci=64,xn=91,vn=93,si=96,yn=123,di=124,bn=125,E={};E[0]="\\0";E[7]="\\a";E[8]="\\b";E[9]="\\t";E[10]="\\n";E[11]="\\v";E[12]="\\f";E[13]="\\r";E[27]="\\e";E[34]='\\"';E[92]="\\\\";E[133]="\\N";E[160]="\\_";E[8232]="\\L";E[8233]="\\P";var ui=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"],fi=/^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;function pi(e,n){var r,t,i,o,l,a,c;if(n===null)return{};for(r={},t=Object.keys(n),i=0,o=t.length;i<o;i+=1)l=t[i],a=String(n[l]),l.slice(0,2)==="!!"&&(l="tag:yaml.org,2002:"+l.slice(2)),c=e.compiledTypeMap.fallback[l],c&&hn.call(c.styleAliases,a)&&(a=c.styleAliases[a]),r[l]=a;return r}function mi(e){var n,r,t;if(n=e.toString(16).toUpperCase(),e<=255)r="x",t=2;else if(e<=65535)r="u",t=4;else if(e<=4294967295)r="U",t=8;else throw new C("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+r+w.repeat("0",t-n.length)+n}var hi=1,K=2;function gi(e){this.schema=e.schema||me,this.indent=Math.max(1,e.indent||2),this.noArrayIndent=e.noArrayIndent||!1,this.skipInvalid=e.skipInvalid||!1,this.flowLevel=w.isNothing(e.flowLevel)?-1:e.flowLevel,this.styleMap=pi(this.schema,e.styles||null),this.sortKeys=e.sortKeys||!1,this.lineWidth=e.lineWidth||80,this.noRefs=e.noRefs||!1,this.noCompatMode=e.noCompatMode||!1,this.condenseFlow=e.condenseFlow||!1,this.quotingType=e.quotingType==='"'?K:hi,this.forceQuotes=e.forceQuotes||!1,this.replacer=typeof e.replacer=="function"?e.replacer:null,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function $e(e,n){for(var r=w.repeat(" ",n),t=0,i=-1,o="",l,a=e.length;t<a;)i=e.indexOf(`
`,t),i===-1?(l=e.slice(t),t=a):(l=e.slice(t,i+1),t=i+1),l.length&&l!==`
`&&(o+=r),o+=l;return o}function se(e,n){return`
`+w.repeat(" ",e.indent*n)}function xi(e,n){var r,t,i;for(r=0,t=e.implicitTypes.length;r<t;r+=1)if(i=e.implicitTypes[r],i.resolve(n))return!0;return!1}function Z(e){return e===Xr||e===Qr}function W(e){return 32<=e&&e<=126||161<=e&&e<=55295&&e!==8232&&e!==8233||57344<=e&&e<=65533&&e!==xe||65536<=e&&e<=1114111}function Le(e){return W(e)&&e!==xe&&e!==zr&&e!==G}function Te(e,n,r){var t=Le(e),i=t&&!Z(e);return(r?t:t&&e!==gn&&e!==xn&&e!==vn&&e!==yn&&e!==bn)&&e!==ce&&!(n===X&&!i)||Le(n)&&!Z(n)&&e===ce||n===X&&i}function vi(e){return W(e)&&e!==xe&&!Z(e)&&e!==ti&&e!==ai&&e!==X&&e!==gn&&e!==xn&&e!==vn&&e!==yn&&e!==bn&&e!==ce&&e!==ni&&e!==ii&&e!==Zr&&e!==di&&e!==oi&&e!==li&&e!==ri&&e!==Jr&&e!==ei&&e!==ci&&e!==si}function yi(e){return!Z(e)&&e!==X}function Y(e,n){var r=e.charCodeAt(n),t;return r>=55296&&r<=56319&&n+1<e.length&&(t=e.charCodeAt(n+1),t>=56320&&t<=57343)?(r-55296)*1024+t-56320+65536:r}function wn(e){var n=/^\n* /;return n.test(e)}var An=1,de=2,En=3,Cn=4,B=5;function bi(e,n,r,t,i,o,l,a){var c,s=0,u=null,d=!1,f=!1,m=t!==-1,h=-1,g=vi(Y(e,0))&&yi(Y(e,e.length-1));if(n||l)for(c=0;c<e.length;s>=65536?c+=2:c++){if(s=Y(e,c),!W(s))return B;g=g&&Te(s,u,a),u=s}else{for(c=0;c<e.length;s>=65536?c+=2:c++){if(s=Y(e,c),s===G)d=!0,m&&(f=f||c-h-1>t&&e[h+1]!==" ",h=c);else if(!W(s))return B;g=g&&Te(s,u,a),u=s}f=f||m&&c-h-1>t&&e[h+1]!==" "}return!d&&!f?g&&!l&&!i(e)?An:o===K?B:de:r>9&&wn(e)?B:l?o===K?B:de:f?Cn:En}function wi(e,n,r,t,i){e.dump=(function(){if(n.length===0)return e.quotingType===K?'""':"''";if(!e.noCompatMode&&(ui.indexOf(n)!==-1||fi.test(n)))return e.quotingType===K?'"'+n+'"':"'"+n+"'";var o=e.indent*Math.max(1,r),l=e.lineWidth===-1?-1:Math.max(Math.min(e.lineWidth,40),e.lineWidth-o),a=t||e.flowLevel>-1&&r>=e.flowLevel;function c(s){return xi(e,s)}switch(bi(n,a,e.indent,l,c,e.quotingType,e.forceQuotes&&!t,i)){case An:return n;case de:return"'"+n.replace(/'/g,"''")+"'";case En:return"|"+Se(n,e.indent)+_e($e(n,o));case Cn:return">"+Se(n,e.indent)+_e($e(Ai(n,l),o));case B:return'"'+Ei(n)+'"';default:throw new C("impossible error: invalid scalar style")}})()}function Se(e,n){var r=wn(e)?String(n):"",t=e[e.length-1]===`
`,i=t&&(e[e.length-2]===`
`||e===`
`),o=i?"+":t?"":"-";return r+o+`
...
`+e.slice(l+1):c+=e.slice(i),c.slice(1)}function Ei(e){for(var n="",r=0,t,i=0;i<e.length;r>=65536?i+=2:i++)r=Y(e,i),t=E[r],!t&&W(r)?(n+=e[i],r>=65536&&(n+=e[i+1])):n+=t||mi(r);return n}function Ci(e,n,r){var t="",i=e.tag,o,l,a;for(o=0,l=r.length;o<l;o+=1)a=r[o],e.replacer&&(a=e.replacer.call(r,String(o),a)),(_(e,n,a,!1,!1)||typeof a>"u"&&_(e,n,null,!1,!1))&&(t!==""&&(t+=","+(e.condenseFlow?"":" ")),t+=e.dump);e.tag=i,e.dump="["+t+"]"}function Ie(e,n,r,t){var i="",o=e.tag,l,a,c;for(l=0,a=r.length;l<a;l+=1)c=r[l],e.replacer&&(c=e.replacer.call(r,String(l),c)),(_(e,n+1,c,!0,!0,!1,!0)||typeof c>"u"&&_(e,n+1,null,!0,!0,!1,!0))&&((!t||i!=="")&&(i+=se(e,n)),e.dump&&G===e.dump.charCodeAt(0)?i+="-":i+="- ",i+=e.dump);e.tag=o,e.dump=i||"[]"}function ki(e,n,r){var t="",i=e.tag,o=Object.keys(r),l,a,c,s,u;for(l=0,a=o.length;l<a;l+=1)u="",t!==""&&(u+=", "),e.condenseFlow&&(u+='"'),c=o[l],s=r[c],e.replacer&&(s=e.replacer.call(r,c,s)),_(e,n,c,!1,!1)&&(e.dump.length>1024&&(u+="? "),u+=e.dump+(e.condenseFlow?'"':"")+":"+(e.condenseFlow?"":" "),_(e,n,s,!1,!1)&&(u+=e.dump,t+=u));e.tag=i,e.dump="{"+t+"}"}function $i(e,n,r,t){var i="",o=e.tag,l=Object.keys(r),a,c,s,u,d,f;if(e.sortKeys===!0)l.sort();else if(typeof e.sortKeys=="function")l.sort(e.sortKeys);else if(e.sortKeys)throw new C("sortKeys must be a boolean or a function");for(a=0,c=l.length;a<c;a+=1)f="",(!t||i!=="")&&(f+=se(e,n)),s=l[a],u=r[s],e.replacer&&(u=e.replacer.call(r,s,u)),_(e,n+1,s,!0,!0,!0)&&(d=e.tag!==null&&e.tag!=="?"||e.dump&&e.dump.length>1024,d&&(e.dump&&G===e.dump.charCodeAt(0)?f+="?":f+="? "),f+=e.dump,d&&(f+=se(e,n)),_(e,n+1,u,!0,d)&&(e.dump&&G===e.dump.charCodeAt(0)?f+=":":f+=": ",f+=e.dump,i+=f));e.tag=o,e.dump=i||"{}"}function Me(e,n,r){var t,i,o,l,a,c;for(i=r?e.explicitTypes:e.implicitTypes,o=0,l=i.length;o<l;o+=1)if(a=i[o],(a.instanceOf||a.predicate)&&(!a.instanceOf||typeof n=="object"&&n instanceof a.instanceOf)&&(!a.predicate||a.predicate(n))){if(r?a.multi&&a.representName?e.tag=a.representName(n):e.tag=a.tag:e.tag="?",a.represent){if(c=e.styleMap[a.tag]||a.defaultStyle,mn.call(a.represent)==="[object Function]")t=a.represent(n,c);else if(hn.call(a.represent,c))t=a.represent[c](n,c);else throw new C("!<"+a.tag+'> tag resolver accepts not "'+c+'" style');e.dump=t}return!0}return!1}function _(e,n,r,t,i,o,l){e.tag=null,e.dump=r,Me(e,r,!1)||Me(e,r,!0);var a=mn.call(e.dump),c=t,s;t&&(t=e.flowLevel<0||e.flowLevel>n);var u=a==="[object Object]"||a==="[object Array]",d,f;if(u&&(d=e.duplicates.indexOf(r),f=d!==-1),(e.tag!==null&&e.tag!=="?"||f||e.indent!==2&&n>0)&&(i=!1),f&&e.usedDuplicates[d])e.dump="*ref_"+d;else{if(u&&f&&!e.usedDuplicates[d]&&(e.usedDuplicates[d]=!0),a==="[object Object]")t&&Object.keys(e.dump).length!==0?($i(e,n,e.dump,i),f&&(e.dump="&ref_"+d+e.dump)):(ki(e,n,e.dump),f&&(e.dump="&ref_"+d+" "+e.dump));else if(a==="[object Array]")t&&e.dump.length!==0?(e.noArrayIndent&&!l&&n>0?Ie(e,n-1,e.dump,i):Ie(e,n,e.dump,i),f&&(e.dump="&ref_"+d+e.dump)):(Ci(e,n,e.dump),f&&(e.dump="&ref_"+d+" "+e.dump));else if(a==="[object String]")e.tag!=="?"&&wi(e,e.dump,n,o,c);else{if(a==="[object Undefined]")return!1;if(e.skipInvalid)return!1;throw new C("unacceptable kind of an object to dump "+a)}e.tag!==null&&e.tag!=="?"&&(s=encodeURI(e.tag[0]==="!"?e.tag.slice(1):e.tag).replace(/!/g,"%21"),e.tag[0]==="!"?s="!"+s:s.slice(0,18)==="tag:yaml.org,2002:"?s="!!"+s.slice(18):s="!<"+s+">",e.dump=s+" "+e.dump)}return!0}function Li(e,n){var r=[],t=[],i,o;for(ue(e,r,t),i=0,o=t.length;i<o;i+=1)n.duplicates.push(r[t[i]]);n.usedDuplicates=new Array(o)}function ue(e,n,r){var t,i,o;if(e!==null&&typeof e=="object")if(i=n.indexOf(e),i!==-1)r.indexOf(i)===-1&&r.push(i);else if(n.push(e),Array.isArray(e))for(i=0,o=e.length;i<o;i+=1)ue(e[i],n,r);else for(t=Object.keys(e),i=0,o=t.length;i<o;i+=1)ue(e[t[i]],n,r)}function Ti(e,n){n=n||{};var r=new gi(n);r.noRefs||Li(e,r);var t=e;return r.replacer&&(t=r.replacer.call({"":t},"",t)),_(r,0,t,!0,!0)?r.dump+`
`:""}var Si=Ti,_i={dump:Si};function ve(e,n){return function(){throw new Error("Function yaml."+e+" is removed in js-yaml 4. Use yaml."+n+" instead, which is now safe by default.")}}var Fi=A,Ii=Be,Mi=Ye,Oi=We,Ni=Ve,Hi=me,Di=pn.load,Bi=pn.loadAll,Ri=_i.dump,ji=C,Pi={binary:Je,float:Ke,map:Pe,null:qe,pairs:nn,set:rn,timestamp:Xe,bool:Ue,int:Ge,merge:Ze,omap:en,seq:je,str:Re},Yi=ve("safeLoad","load"),qi=ve("safeLoadAll","loadAll"),Ui=ve("safeDump","dump"),Gi={Type:Fi,Schema:Ii,FAILSAFE_SCHEMA:Mi,JSON_SCHEMA:Oi,CORE_SCHEMA:Ni,DEFAULT_SCHEMA:Hi,load:Di,loadAll:Bi,dump:Ri,YAMLException:ji,types:Pi,safeLoad:Yi,safeLoadAll:qi,safeDump:Ui};async function S(e){const r=await(await fetch(e)).text();return Gi.load(r)}async function Ki(e,n,r){const i=(r.heroSelections||[]).map(o=>{const l=o.color||"#18428F";return o.scrollTo?`<a href="#/" data-scroll-to="${o.scrollTo}" class="hero-bar-button" style="background-color: ${l}"><span class="hero-bar-button-inner">${o.label}<span class="hero-bar-arrow"> &rarr;</span></span></a>`:o.path?`<a href="#${o.path}" class="hero-bar-button" style="background-color: ${l}"><span class="hero-bar-button-inner">${o.label}<span class="hero-bar-arrow"> &rarr;</span></span></a>`:`<a href="#/" class="hero-bar-button" style="background-color: ${l}"><span class="hero-bar-button-inner">${o.label}<span class="hero-bar-arrow"> &rarr;</span></span></a>`}).join("");e.innerHTML=`
  ...
  `;const n=document.getElementById("events-list");try{const r=await fetch(`${Zi}data/events.json`);if(!r.ok){n.innerHTML=`
      ...
      <div class="timeline-container" id="timeline-scroll-container">
        <div class="timeline-track">
          ${i.map(l=>{const a=l.summary||"Untitled Event",{category:c,color:s}=nt(a),u=rt(a),{dateStr:d,timeStr:f}=it(l),m=l.description?`<p class="font-body text-sm text-gray-500 mt-2 line-clamp-2">${oe(l.description)}</p>`:"";return`
                <div class="timeline-event" style="--event-color: ${s}" onclick="window.location.hash='#/contact'">
                  <div class="timeline-card">
                    <span class="timeline-category">${oe(c)}</span>
                    <h3 class="font-heading font-semibold text-primary-dark mt-1">${oe(u)}</h3>
                    <p class="font-body text-sm text-gray-500 mt-1">${d}</p>
                    <p class="font-body text-sm text-gray-400">${f}</p>
                    ${m}
    ...
    `;const o=document.getElementById("timeline-scroll-container");o&&o.addEventListener("wheel",l=>{o.scrollWidth>o.clientWidth&&(l.preventDefault(),o.scrollLeft+=l.deltaY)},{passive:!1})}catch{n.innerHTML=`
    ...
    `}}function oe(e){const n=document.createElement("div");return n.textContent=e,n.innerHTML}async function ot(e,n){e.innerHTML=`
    <div class="max-w-6xl mx-auto px-4 py-12" style="margin-top: 60px;">
  ...
  `,i.addEventListener("click",o=>{(o.target===i||o.target.classList.contains("lightbox-close"))&&i.remove()}),document.addEventListener("keydown",function o(l){l.key==="Escape"&&(i.remove(),document.removeEventListener("keydown",o))}),document.body.appendChild(i)}function J(e){const n=document.createElement("div");return n.textContent=e,n.innerHTML}async function ct(e,n,r){e.innerHTML=`
  ...
  `;try{const t=await S(`${n}data/programs.yaml`),i=document.getElementById("program-item-content");let o=null,l=null;for(const h of t.programs){for(const g of h.items)if(g.slug===r){o=g,l=h;break}if(o)break}if(!o){i.innerHTML=`
      ...
      `:"",d=st(o.faq),f=ut(o.experiments),m=pt(o.roles);i.innerHTML=`
    ...
    `,dt(),ft()}catch{const t=document.getElementById("program-item-content");t&&(t.innerHTML='<p class="text-red-500 font-body">Failed to load program details.</p>')}}function st(e){return!e||e.length===0?"":`
    <div class="program-item-section">
  ...
  `}function dt(){document.querySelectorAll(".faq-question").forEach(n=>{n.addEventListener("click",()=>{const r=n.getAttribute("data-faq-index"),t=document.querySelector(`.faq-answer[data-faq-answer="${r}"]`),i=n.querySelector(".faq-chevron"),o=t.classList.contains("open");document.querySelectorAll(".faq-answer").forEach(l=>l.classList.remove("open")),document.querySelectorAll(".faq-chevron").forEach(l=>l.classList.remove("open")),o||(t.classList.add("open"),i.classList.add("open"))})})}function ut(e){if(!e||e.length===0)return"";const n=new Set,r=new Set;e.forEach(c=>{c.grade&&n.add(c.grade),c.time&&r.add(c.time)});const t=[...n].map(c=>`<button class="experiment-filter-btn" data-filter-type="grade" data-filter-value="${O(c)}">${v(c)}</button>`).join(""),i=[...r].map(c=>`<button class="experiment-filter-btn" data-filter-type="time" data-filter-value="${O(c)}">${v(c)}</button>`).join(""),l=n.size>0||r.size>0?`
  ...
  `}function ft(){const e=document.querySelectorAll(".experiment-filter-btn"),n=document.querySelectorAll(".experiment-card");e.length!==0&&e.forEach(r=>{r.addEventListener("click",()=>{e.forEach(o=>o.classList.remove("active")),r.classList.add("active");const t=r.getAttribute("data-filter-type"),i=r.getAttribute("data-filter-value");n.forEach(o=>{t==="all"||o.getAttribute(`data-${t}`)===i?o.classList.remove("hidden-card"):o.classList.add("hidden-card")})})})}function pt(e){return!e||e.length===0?"":`
    <div class="program-item-section">
  ...
  `}function v(e){const n=document.createElement("div");return n.textContent=e,n.innerHTML}function O(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}async function mt(e,n){e.innerHTML=`
  ...
  `;try{const r=await S(`${n}data/programs.yaml`),t=document.getElementById("programs-content");if(!t)return;t.innerHTML=r.programs.map((i,o)=>{const a=i.items.map(c=>{let s="",u="";return c.link?s=c.link:c.scrollTo?(s="#/",u=`data-scroll-to="${c.scrollTo}"`):c.slug&&(s=`#/programs/${c.slug}`),`
        ...
        `}).join("")}catch{const r=document.getElementById("programs-content");r&&(r.innerHTML='<p class="text-red-500 font-body">Failed to load programs.</p>')}}function D(e){const n=document.createElement("div");return n.textContent=e,n.innerHTML}async function ht(e,n){e.innerHTML=`
  ...
  `;try{const r=await S(`${n}data/contact.yaml`),t=document.getElementById("contact-content");if(!t)return;const i="stkayla@gmail.com",o="",l=r.description?`<p class="font-body text-gray-600 mb-8 text-center">${gt(r.description)}</p>`:"";if(!i||i.includes("your-email@example.com")){t.innerHTML=`
        ${l}
    ...
    `}catch{const r=document.getElementById("contact-content");r&&(r.innerHTML='<p class="text-red-500 font-body">Failed to load contact information.</p>')}}function gt(e){const n=document.createElement("div");return n.textContent=e,n.innerHTML}function Ne(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const L="/website-test/";let le=null;async function xt(){const e=await S(`${L}data/site.yaml`);le=await S(`${L}data/programs.yaml`),document.title=e.name;const n=document.getElementById("app");n.innerHTML=vt(e,le);const r=document.getElementById("page-content"),t={"/":a=>Ki(a,L,e),"/news":a=>zi(a,L),"/events":a=>tt(a),"/board":a=>ot(a,L),"/gallery":a=>lt(a,L),"/programs":a=>mt(a,L),"/contact":a=>ht(a,L),"/404":a=>{a.innerHTML=`
        ...
        </div>`}};for(const a of le.programs)for(const c of a.items)c.slug&&!c.link&&!c.scrollTo&&(t[`/programs/${c.slug}`]=s=>ct(s,L,c.slug));new kn(t).init(r);const o=document.getElementById("floating-menu-toggle"),l=document.getElementById("floating-mobile-menu");o&&l&&o.addEventListener("click",()=>{l.classList.toggle("hidden")}),wt(),At(),Et()}function vt(e,n){var c;const r=e.floatingNav.filter(s=>!s.external),t=e.floatingNav.find(s=>s.external),i=r.map(s=>s.label==="Programs"?yt(s,n):s.scrollTo?`<a href="#/" data-scroll-to="${s.scrollTo}" data-nav-link class="nav-link">${s.label}</a>`:`<a href="#${s.path}" data-nav-link class="nav-link">${s.label}</a>`).join(""),o=t?`<a href="${t.path}" target="_blank" rel="noopener noreferrer" class="nav-link-parent">${t.label}</a>`:"",l=bt(e,n),a=e.socials?e.socials.map(s=>`<a href="${s.url}" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-white transition-colors" aria-label="${s.platform}">${s.platform}</a>`).join(" | "):"";return`
    <!-- Top Navigation -->
  ...
  `}function yt(e,n){const r=n.programs.map(t=>{const i=t.items.map(o=>o.link?`<a href="${o.link}" class="dropdown-flat-item">${o.name}</a>`:o.scrollTo?`<a href="#/" data-scroll-to="${o.scrollTo}" class="dropdown-flat-item">${o.name}</a>`:`<a href="#/programs/${o.slug}" class="dropdown-flat-item">${o.name}</a>`).join("");return`
  ...
  `}function bt(e,n){return e.floatingNav.map(r=>{if(r.external)return`<a href="${r.path}" target="_blank" rel="noopener noreferrer" class="block px-4 py-2 font-body font-bold text-white hover:bg-primary-dark/50 transition-colors">${r.label}</a>`;if(r.label==="Programs"){const t=n.programs.map(i=>{const o=i.items.map(l=>l.link?`<a href="${l.link}" class="block px-8 py-1 font-body text-xs text-gray-400 hover:text-white transition-colors">${l.name}</a>`:l.scrollTo?`<a href="#/" data-scroll-to="${l.scrollTo}" class="block px-8 py-1 font-body text-xs text-gray-400 hover:text-white transition-colors">${l.name}</a>`:`<a href="#/programs/${l.slug}" class="block px-8 py-1 font-body text-xs text-gray-400 hover:text-white transition-colors">${l.name}</a>`).join("");return`
          ...
          ${t}
        `}return r.scrollTo?`<a href="#/" data-scroll-to="${r.scrollTo}" data-nav-link class="block px-4 py-2 font-body text-gray-200 hover:text-white hover:bg-primary-dark/50 transition-colors">${r.label}</a>`:`<a href="#${r.path}" data-nav-link class="block px-4 py-2 font-body text-gray-200 hover:text-white hover:bg-primary-dark/50 transition-colors">${r.label}</a>`}).join("")}function wt(){document.addEventListener("click",e=>{const n=e.target.closest("[data-scroll-to]");if(!n)return;e.preventDefault();const r=n.dataset.scrollTo,t=window.location.hash||"#/",i=t==="#/"||t==="#"||t==="",o=document.getElementById("floating-mobile-menu");o&&o.classList.add("hidden"),i?fe(r):(window.location.hash="#/",setTimeout(()=>fe(r),400))})}function At(){const e={"#/about":"about-section"};window.addEventListener("hashchange",()=>{const n=window.location.hash,r=e[n];r&&(window.location.hash="#/",setTimeout(()=>fe(r),400))})}function fe(e){var r;const n=document.getElementById(e);if(n){const t=((r=document.getElementById("floating-nav"))==null?void 0:r.offsetHeight)||0,i=n.getBoundingClientRect().top+window.scrollY-t-16;window.scrollTo({top:i,behavior:"smooth"})}}function Et(){const e=document.getElementById("floating-nav");if(!e)return;let n=!1;function r(){window.scrollY>10?e.classList.add("nav-scrolled"):e.classList.remove("nav-scrolled"),n=!1}window.addEventListener("scroll",()=>{n||(requestAnimationFrame(r),n=!0)}),r()}xt();
