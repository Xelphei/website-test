...
`:""}var Li=ki,_i={dump:Li};function ge(e,n){return function(){throw new Error("Function yaml."+e+" is removed in js-yaml 4. Use yaml."+n+" instead, which is now safe by default.")}}var Si=w,Fi=He,$i=Pe,Ii=Ge,Mi=Ke,Oi=fe,Ni=dn.load,Hi=dn.loadAll,Di=_i.dump,Bi=E,Ri={binary:Xe,float:qe,map:Re,null:je,pairs:Je,set:en,timestamp:Qe,bool:Ye,int:Ue,merge:ze,omap:Ze,seq:Be,str:De},Pi=ge("safeLoad","load"),ji=ge("safeLoadAll","loadAll"),Yi=ge("safeDump","dump"),Ui={Type:Si,Schema:Fi,FAILSAFE_SCHEMA:$i,JSON_SCHEMA:Ii,CORE_SCHEMA:Mi,DEFAULT_SCHEMA:Oi,load:Ni,loadAll:Hi,dump:Di,YAMLException:Bi,types:Ri,safeLoad:Pi,safeLoadAll:ji,safeDump:Yi};async function _(e){const r=await(await fetch(e)).text();return Ui.load(r)}async function qi(e,n,r){const i=(r.heroSelections||[]).map(o=>{const l=o.color||"#18428F";return o.scrollTo?`<a href="#/" data-scroll-to="${o.scrollTo}" class="hero-bar-button gradient-text-hover" style="background-color: ${l}">${o.label}</a>`:o.path?`<a href="#${o.path}" class="hero-bar-button gradient-text-hover" data-circle-expand style="background-color: ${l}">${o.label}</a>`:`<a href="#/" class="hero-bar-button gradient-text-hover" style="background-color: ${l}">${o.label}</a>`}).join("");e.innerHTML=`
  ...
  `;try{const r=await _(`${n}data/contact.yaml`),t=document.getElementById("contact-content");if(!t)return;const i="",o=r.description?`<p class="font-body text-gray-600 mb-8 text-center">${ct(r.description)}</p>`:"",l=i&&!i.includes("YOUR_FORM_ID")?`
